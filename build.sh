...
node ./node_modules/babel-cli/bin/babel.js ./tmp/_common-interface.js -o ./tmp/common-interface.js
node ./node_modules/babel-cli/bin/babel.js ./tmp/_mongodb-interface.js -o ./tmp/mongodb-interface.js
node ./node_modules/babel-cli/bin/babel.js ./tmp/_index.js -o ./tmp/index.js
