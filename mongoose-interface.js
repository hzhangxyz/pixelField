...
var edgeSize = 128;
var edgeMax = 1024;
var savePeriod = 1000;//1s
var keepAliveTime = 1000;
var defaultUrl = "mongodb://localhost:27017/pixelField_test"
var modelName = "tree"
...
var db = mongoose.createConnection(defaultUrl,{keepAlive: 1000})
var TreeNode = db.model(modelName,treeSchema);

async function test(){
  TreeNode.dropData()
  await TreeNode.addPoints([{x:0,y:0,r:105,g:202,b:106}])
  await TreeNode.addPoints([{x:0,y:0,r:135,g:252,b:196}])
